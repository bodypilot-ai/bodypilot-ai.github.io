...
<div id="startscreen" class="startscreen"><div class="startcard">
  ...
  <p>共 <b>30 例</b>。每例包含两份匿名 AI 体重管理建议（A / B，顺序随机）。</p>
  <p><b>两份建议均由 AI 系统自动生成，但来自不同的自动化方案。</b>您不会被告知每份建议来自哪个系统，请仅根据建议<b>本身的质量</b>评分。</p>
  <p>请完成两项评价：</p>
  <ol style="margin:4px 0 8px 20px;padding:0;font-size:14px;line-height:1.7">
    <li>分别为 A、B 两份建议的 <b>6 个维度</b>评分（1–5 分）<span class="tag">（正确性·一致性·个性化·可执行性·安全性·清晰度）</span></li>
    <li>选择您<b>更愿意发给患者</b>的一份</li>
  </ol>
  <p class="tag">预计用时 20–30 分钟，可分次完成，评分会自动保存在本机。</p>
  <div class="legend"><b>评分标准：</b>5＝优秀，无明显问题 ｜ 4＝较好，仅有小瑕疵 ｜ 3＝基本可接受，但有明显不足 ｜ 2＝较差，存在明显问题 ｜ 1＝很差，存在严重问题。<br>如发现<b>可能直接造成伤害</b>的内容，请勾选「不安全」。</div>
